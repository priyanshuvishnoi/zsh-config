# Generated by Powerlevel10k configuration wizard on 2021-04-29 at 11:46 IST.
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND='#03a1fc'
  typeset -g POWERLEVEL9K_USER_FOREGROUND='#fff'
  # Custom icon.
